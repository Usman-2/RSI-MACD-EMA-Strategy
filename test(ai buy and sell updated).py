...
orders, closed_signals, current_position = execute_orders(model_tesla.predict(new_tesla_data[['ema', 'rsi', 'macd', 'vwap']]), new_tesla_data['Open'], current_position)
...
buy_signals, sell_signals, losses = count_buy_sell_losses(model_tesla.predict(new_tesla_data[['ema', 'rsi', 'macd', 'vwap']]), new_tesla_data['Close'])
